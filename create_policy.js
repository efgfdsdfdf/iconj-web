...
const dir = path.join(process.cwd(), 'src/app/customization-policy');
if (!fs.existsSync(dir)) fs.mkdirSync(dir);

const file = path.join(dir, 'page.tsx');
const content = `import { Footer } from "@/components/layout/Footer";
      ...
      <main className="flex-grow pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100">
          ...
          <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
            <p>
              At ICONJ, we coordinate the fulfillment of customizable window décor according to your exact specifications. 
...
console.log('Created Customization Policy page');
