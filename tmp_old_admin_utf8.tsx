      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="border-none shadow-sm">
          <CardContent className="p-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900">Γéª{totalRevenue.toLocaleString()}</h3>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-sm">
          <CardContent className="p-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900">Γéª{totalProfit.toLocaleString()}</h3>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-sm">
          <CardContent className="p-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900">Γéª{totalSupplierBalance.toLocaleString()}</h3>
          </CardContent>
        </Card>
                  ...
                  {recentOrders && recentOrders.length > 0 ? (
                    recentOrders.map((order: any) => (
                      <tr key={order.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-6 py-4 text-right font-bold">Γéª{Number(order.total_amount).toLocaleString()}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
