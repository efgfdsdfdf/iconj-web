...
export default async function IconjMarketingPage() {
  ...
  const categories = dbCategories && dbCategories.length > 0 ? dbCategories : [
    { id: 1, name: 'Baby & Mother', icon: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=500&q=80' },
    { id: 2, name: 'Fashion', icon: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=500&q=80' },
    { id: 3, name: 'Electronics', icon: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=500&q=80' },
    { id: 4, name: 'Beauty', icon: 'https://images.unsplash.com/photo-1596462502278-27bf85033c44?w=500&q=80' },
    { id: 5, name: 'Home & Living', icon: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=500&q=80' },
    { id: 6, name: 'Accessories', icon: 'https://images.unsplash.com/photo-1523206489230-c012c64b2b48?w=500&q=80' },
  ];
